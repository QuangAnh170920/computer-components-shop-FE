export const API_ROUTER = {
    ...
    DROP_LIST: {
        ...
        CATEGORIES_PARENT_LIST: '/v1/admin/drop-list/categories/exclude-children/',
    ...
    PROMOTION: {
        CREATE: '/v1/api/admin/promotion/create',
        UPDATE: '/v1/api/admin/promotion/update',
        UPDATE_STATUS: '/v1/api/admin/promotion/update-status',
        SEARCH: '/v1/api/admin/promotion/find-all-and-search',
        DELETE: '/v1/api/admin/promotion/delete/',
