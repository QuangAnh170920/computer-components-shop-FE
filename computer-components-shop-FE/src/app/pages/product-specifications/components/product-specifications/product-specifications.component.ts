...
import { ProductSpecificationsDetailComponent } from '../product-specifications-detail/product-specifications-detail.component';
...
export class ProductSpecificationsComponent {
  ...
  private _loadDialog(data: any, e: EFormAction) {
    ...
    const ref = this.dialogService.open(ProductSpecificationsDetailComponent, {
      header: _title,
      footer: ' ',
      width: '50%',
