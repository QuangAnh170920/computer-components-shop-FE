...
import { ProductSpecificationsDetailComponent } from './components/product-specifications-detail/product-specifications-detail.component';
...
@NgModule({
  declarations: [
    ...
    ProductSpecificationsDetailComponent
  ],
  imports: [
    CommonModule,
